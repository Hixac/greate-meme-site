...
def include_object(object, name, type_, reflected, compare_to):  # pyright: ignore
    # Exclude tables/indexes marked with skip_autogenerate
    if type_ in ("table", "index") and hasattr(object, "info"):
        if object.info.get("skip_autogenerate"):  # pyright: ignore
            return False
...
async def run_migrations_online() -> None:
    ...
    async with connectable.connect() as connection:
        connection.run_sync(do_run_migration)
